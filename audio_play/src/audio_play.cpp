  ...
  class RosGstPlay
  {
    public:
      RosGstPlay()
      {
        ...
        // Need to subscribe raw wave data
        ...
        if (_input_format == "mp3") {
          ...
          ROS_ERROR_STREAM("Unsupported input media type.");
          exit(1);
        }
        ...
        else
        {
          ...
          if (_input_format == "wave")
          {
            ...
            if (_output_format == "wave") {
              ...
              ROS_ERROR_STREAM("Unsupported output media type.");
              exit(1);
            }
